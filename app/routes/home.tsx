...
import { ArrowDownRight, ArrowRight, BookOpen, Braces, Check, FileText, Gamepad2, Menu, MessageCircle, Mic2, MoonStar, MousePointer2, Sparkles, WandSparkles, X } from 'lucide-react';
import type { Route } from './+types/home';

export function meta({}: Route.MetaArgs) {
  const title = 'Oppia - Five ways to move forward';
  const description =
  ...
  return [
    ...
    { property: 'og:url', content: 'https://oppia.world' },
...
export default function Home() {
  ...
  return <main>
    ...
    <section className="final-cta" id="about"><div className="cta-orb"><span>O</span></div><p className="kicker light"><span/>Your next useful thing</p><h2>Five products.<br/>One place to begin.</h2><p>Choose the moment you want to improve. Oppia will help you move it forward.</p><a className="button white" href="#products">Explore the ecosystem <ArrowRight size={18}/></a></section>
    <footer><a className="brand footer-brand" href="#top"><span className="brand-mark"><img src="/oppia-logo.png" alt="" /></span><span>oppia</span></a><p>Thoughtful digital products for everyday progress.</p><nav><a href="#products">Products</a><a href="#principles">Principles</a><a href="#about">About</a><a href="#">Privacy</a><a href="#">Terms</a></nav><small>© 2026 Oppia World</small></footer>
  </main>;
}
