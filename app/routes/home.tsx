...
export function meta({ }: Route.MetaArgs) {
  ...
  const description =
    'Thoughtful digital products for reading, learning, speaking, building, and creating. Explore Moozhaf, PICA, Tolk, Toolhub, and Writer.';
...
export default function Home() {
  ...
  return <main>
    ...
    <section className="final-cta" id="about"><div className="cta-orb"><img src="/logo-small.png" width={75} height={75} /></div><p className="kicker light"><span />Your next useful thing</p><h2>Five products.<br />One place to begin.</h2><p>Choose the moment you want to improve. Oppia will help you move it forward.</p><a className="button white" href="#products">Explore the ecosystem <ArrowRight size={18} /></a></section>
